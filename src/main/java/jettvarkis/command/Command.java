 ...
 * All specific commands (e.g., ByeCommand, AddCommand) should extend this class.
 */
public abstract class Command {
    /**
     * Executes the command.
     * This method must be implemented by concrete command classes to define their specific behavior.
     *
     ...
     *
     * @return True if this command signifies an exit from the application, false otherwise.
     */
